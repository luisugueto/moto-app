        ...
        <div class="col-lg-12">
            <div class="main-card mb-3 card">
                <div class="card-body">
                    ...
                    {!! Form::model($purchase, ['route' => ['purchase_valuation.update', $purchase->id], 'method' => 'put', 'enctype' => 'multipart/form-data']) !!}
                                ...
                                <div class="form-row row g-1">
                                    <div class="col-md-3">
                                        <div class="position-relative form-group">
                                            ...
                                            <select class="form-control" name="brand" id="brand" onChange="setModel()" required>
                                    ...
                                    <div class="col-md-3">
                                        <div class="position-relative form-group">
                                            ...
                                            <input name="year" id="year" type="date"
                                                class="form-control" value="{{ $purchase->year }}" required>
                                            @if ($errors->has('year'))
                                                <span class="error text-danger">
                                    ...
                                    <div class="col-md-3">
                                        <div class="position-relative form-group">
                                            ...
                                            <input name="km" id="km" type="text"
                                                class="form-control" value="{{ $purchase->km }}" required>
                                            @if ($errors->has('km'))
                                                <span class="error text-danger">
                                    ...
                                    <div class="col-md-6">
                                        <div class="position-relative form-group">
                                            ...
                                            <input name="lastname" id="lastname" type="text" class="form-control"
                                                value="{{ $purchase->lastname }}" required>
                                    ...
                                    <div class="col-md-4">
                                        <div class="position-relative form-group">
                                            ...
                                            <input name="province" id="province" type="province" class="form-control"
                                                value="{{ $purchase->province }}" required>
                                ...
                                <div class="form-row row g-1">
                                        ...
                                        <div class="position-relative form-group">
                                            ...
                                            <div class="custom-radio custom-control custom-control-inline">
                                                <input type="radio" id="high" name="status_trafic"
                                                    class="custom-control-input" value="Alta" {{ $purchase->status_trafic == 'Alta' ? 'checked' : '' }}>
                                                <label class="custom-control-label" for="high">Alta</label>
                                            </div>
                                            <div class="custom-radio custom-control custom-control-inline">
                                                <input type="radio" id="final_discharge" name="status_trafic"
                                                    class="custom-control-input" value="Baja definitiva" {{ $purchase->status_trafic == 'Baja definitiva' ? 'checked' : '' }}>
                                    ...
                                    <div class="col-md-12">
                                        <div class="position-relative form-group">
                                            ...
                                            <textarea class="form-control" name="observations">{{ $purchase->observations }}</textarea>
                                        </div>
                                    </div>
                                    <div class="col-md-4">
                                        <div class="position-relative form-group">
                                            <label for="status_vehicle" class="">¿Cual es el precio mínimo que aceptas?: </label>
                                            <input type="number" step="any" class="form-control" id="price_min" name="price_min" value="{{ $purchase->price_min }}" required>
                                        </div>
                                    </div>
