...
class PurchaseValuation extends Model
{
    ...
    protected $fillable = [
    	'date', 'brand', 'model', 'year', 'km', 'email', 'name', 'lastname', 'phone', 'province', 'status_trafic', 'motocycle_state', 'price_min', 'observations', 'states_id', 'data_serialize', 'exist_model_brand', 'documents_destruction', 'destruction_code', 'destruction_deceased', 'destruction_code', 'possible_sale', 'possible_sale_code', 'possible_sale_deceased', 'sale_deceased_code', 'created_at'
    ];
