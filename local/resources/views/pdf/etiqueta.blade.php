    ...
    <body>
        <div class="container-fluid">
            <table style="border-collapse:collapse;margin-left:40.624pt;margin-top: 6pt;width:700px;" cellspacing="0">
                <tr style="height:35mm;">
                    <td style="width:251pt">
                        <p class="s1" style="padding-left: 19pt;padding-right: 76pt;text-indent: 0pt;text-align: center;"><span>NºExpediente: L{{ $purchase->id }}<br/>Marca: {{ strtoupper($purchase->brand) }}</span></p>
            ...
            <table style="border-collapse:collapse;margin-left:40.624pt;margin-top: 4pt;width:700px; " cellspacing="0">
                <tr style="height:35mm;">
                    <td style="width:251pt">
                        <p class="s2" style="padding-top: 3pt;padding-left: 1pt;padding-right: 38pt;text-indent: 0pt;text-align: center;"><span>L{{ $purchase->id }} {{ strtoupper($purchase->brand) }}<br/>{{ strtoupper(nl2br($purchase_management->model)) }}</span></p>
                    </td>
                    <td style="width:252pt">
                        <p class="s2" style="padding-top: 3pt;padding-left: 1pt;padding-right: 38pt;text-indent: 0pt;text-align: center;"><span>L{{ $purchase->id }} {{ strtoupper($purchase->brand) }}<br/>{{ strtoupper(nl2br($purchase_management->model)) }}</span></p>
                    </td>
