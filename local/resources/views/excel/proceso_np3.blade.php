...
<table>
    <tr stye="font-family: Arial;font-size: 10;text-align: center;vertical-align:middle;">
        ...
        <td style="width: 30;border: 2px medium #000;">
            <p style="text-align: center;vertical-align:middle;">CANTIDAD TOTAL ENVIADA</p>
        </td>
        <td style="width: 40;border: 2px medium #000;">
            <p style="text-align: center;vertical-align:middle;">CANTIDAD TOTAL PENDIENTE DE ENTREGA</p>
        </td>
    </tr>
    <tr style="text-align: center">
        ...
        <td style="width: 30;height: 20;border: 2px medium #000;vertical-align:middle;">Razón social de Inst. destino</td>
        <td style="width: 30;height: 20;border: 2px medium #000;vertical-align:middle;">NIMA de la instalación destino</td>
        <td style="width: 50;height: 20;border: 2px medium #000;vertical-align:middle;">Dirección (tipo via, nombre vía, número, piso, puerta)
        </td>
        <td style="width: 13;height: 20;border: 2px medium #000;vertical-align:middle;">Código Postal</td>
        <td style="width: 10;height: 20;border: 2px medium #000;vertical-align:middle;">Localidad</td>
        <td style="width: 10;height: 20;border: 2px medium #000;vertical-align:middle;">Provincia</td>
        <td style="width: 10;height: 20;border: 2px medium #000;vertical-align:middle;">País</td>
        <td style="height: 20;border: 2px medium #000;">&nbsp;</td>
...
<table>
    ...
    <tr>
        ...
        <td style="text-align: left;border: 2px medium #000;">NP03</td>
        ...
        <td style="height: 20;text-align: right;border: 2px medium #000;">={{ (($data[$i]->materialC->material->valorization * $data[$i]->delivery)/100)*$p }}</td>
    </tr>
    @endfor
</table>
