...
@section('content')
    <div class="app-page-title">
        <div class="page-title-wrapper">
            <div class="page-title-heading">
                ...
                <div><span class="lang" key="heading">Servicios</span>
                </div>
            </div>
    ...
    <div class="row">
        <div class="col-lg-12">
            ...
            <div class="main-card mb-3 card">
                <div class="card-body">
                    <h5 class="card-title lang" key="heading">Mantenimiento de Servicios</h5>
                    <table style="width: 100%;" class="table table-hover table-striped table-bordered" id="tableServices">
                        <thead>
                            <tr>
                                <th>#</th>
                                <th>Nombre</th>
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="exampleModalLongTitle">Formulario Servicios</h5>
                ...
                <div class="modal-body">
                    ...
                    <form id="frmServices" name="frmServices" novalidate="">
                        {{ csrf_field() }}
    ...
    <script src="{{ asset('assets/scripts/js/services.js') }}"></script>
    @endsection
@endsection
