    ...
    <div class="col-lg-12">
        ...
        <div class="main-card mb-3 card">
            <div class="card-body">
                ...
                <hr>
                <table width="100%" id="tableTasacionMotos" class="table table-hover table-striped table-bordere">
                    <thead>
                        <tr>
                            <th></th>
                            <th>#</th>
...
<script>
 ...
 <script src="{{ asset('assets/scripts/js/purchase_valuation_interested.js') }}"></script>
