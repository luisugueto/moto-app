...
class CreatePurchaseValuationTable extends Migration
{
    ...
    public function up()
    {
        Schema::create('purchase_valuation', function (Blueprint $table) {
            ...
            $table->text('documents_destruction');
            $table->text('destruction_code');
            $table->text('destruction_deceased');
            $table->text('destruction_deceased_code');
            $table->text('possible_sale');
            $table->text('possible_sale_code');
            $table->text('possible_sale_deceased');
            $table->text('sale_deceased_code');
            $table->timestamps();
        });
    }
